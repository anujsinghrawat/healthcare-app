...
import 'package:health_care_app/presentation/article_screen/models/article_model.dart';
  ...
  List<TrendingsItemModel> fillTrendingsItemList() {
    return [
      TrendingsItemModel(
          ...
          bookmark: ImageConstant.imgBookmark,
          description:
              "Comparing the \nAstraZeneca and \nSinovac COVID-19 \nVaccines",
          date: "Jun 12, 2021",
          time: "6 min read"),
  ...
  List<NinetyfourItemModel> fillNinetyfourItemList() {
    return [
      NinetyfourItemModel(
          ...
          date: "Jun 10, 2021 ",
          time: "5min read",
          image1: ImageConstant.imgBookmarkCyan300),
      NinetyfourItemModel(
