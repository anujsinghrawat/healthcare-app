...
class PharmacyScreen extends StatelessWidget {
  ...
  Widget _buildOfferBanner(BuildContext context) {
    return Container(
        width: 335.h,
        margin: EdgeInsets.only(left: 20.h, top: 25.v, right: 20.h),
  ...
  Widget _buildPopularProductRow(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: 20.h, top: 52.v, right: 20.h),
        child: Row(
            ...
            child: BlocSelector<PharmacyBloc, PharmacyState, PharmacyModel?>(
                ...
                builder: (context, pharmacyModelObj) {
                  return ListView.separated(
                      padding: EdgeInsets.only(left: 21.h, top: 23.v),
    ...
    return Align(
        ...
        child: SizedBox(
            ...
            child: BlocSelector<PharmacyBloc, PharmacyState, PharmacyModel?>(
                ...
                builder: (context, pharmacyModelObj) {
                  return ListView.separated(
                      padding: EdgeInsets.only(left: 21.h, top: 11.v),
                      scrollDirection: Axis.horizontal,
                      separatorBuilder: (context, index) {
